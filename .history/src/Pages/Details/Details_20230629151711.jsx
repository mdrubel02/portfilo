                        ...
                        <div className='flex gap-x-6'>
                            <div className='w-[45%]'>
                                ...
                                <div>
                                    ...
                                    <button className='btn btn-sm mb-3 bg-[#2eca7f] border-0 text-white hover:bg-white hover:text-[#2eca7f] hover:drop-shadow-xl'><a href={data?.live_site} target="_blank">Live Website</a></button>
                                    <button className='btn btn-sm mb-3 bg-[#2eca7f] border-0 text-white hover:bg-white hover:text-[#2eca7f] hover:drop-shadow-xl'><a href={data?.client_Code} target="_blank">Client-Site Code</a></button>
                                    <button className='btn btn-sm mb-3 bg-[#2eca7f] border-0 text-white hover:bg-white hover:text-[#2eca7f] hover:drop-shadow-xl'><a href={data?.server_Code} target="_blank">Server-Site Code</a></button>
                                </div>
                            </div>
