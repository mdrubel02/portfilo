                    ...
                    <div className='w-[100%] mx-auto'>
                        ...
                        <div className='flex gap-x-6'>
                            ...
                            <div className='w-[55%]'>
                                ...
                                <h1 className='flex items-center mb-2 mt-4 text-primary'><FaStickyNote className='text-accent text-2xl mr-2' /> <p className='font-bold text-xl text-secondary'>Top Features</p></h1>
                                {
