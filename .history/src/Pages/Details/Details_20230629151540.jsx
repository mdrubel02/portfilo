                        ...
                        <div className='flex gap-x-6'>
                            <div className='w-[45%]'>
                                ...
                                <div>
                                    ...
                                    <button className='btn btn-primary btn-sm mr-2'><a href={data?.live_site} target="_blank">Live Website</a></button>
                                    <button className='btn btn-primary btn-sm mr-2'><a href={data?.client_Code} target="_blank">Client-Site Code</a></button>
