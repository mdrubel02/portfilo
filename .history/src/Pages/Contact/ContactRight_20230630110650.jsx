            ...
            <div>
                ...
                <div className='mt-8'>
                    <form action="">
                        ...
                        <button type='submit' className='btn btn-lg mb-3 bg-[#2eca7f] border-0 text-white hover:bg-white hover:text-[#2eca7f] hover:drop-shadow-xl mt-3 w-full'>Submit</button>
                        </div>
                    </form>
                </div>
            </div>
