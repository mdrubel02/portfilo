                ...
                <div className='lg:flex mt-4'>
                    ...
                    <div className='lg:w-1/2 flex lg:justify-start  items-center max-[600px]:justify-center max-[600px]:mt-[-20px]'>
                        <div className='mt-20 w-auto'>
                            ...
                            <p className='text-center mt-3 text-xl text-white font-bold font-poppins'> <TextTransition springConfig={presets.gentle}>{TEXTS[index % TEXTS.length]}</TextTransition></p>
