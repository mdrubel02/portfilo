        ...
        <section className='max-w-4xl mx-auto'>
            <div className='flex flex-col md:flex-row'>
                <div className='md:w-3/6 mt-14 max-[600px]:ms-5'>
                    <h2 className='text-2xl font-bold font-poppins text-black mb-3'>About <span className='text-[#2eca7f] '>Me</span></h2>
                    ...
                    <button className='btn btn-sm mb-3 bg-[#2eca7f] border-0 text-white hover:bg-white hover:text-[#2eca7f] hover:drop-shadow-xl'> <a href={CV} download className='btn'>Download Resume</a></button>
