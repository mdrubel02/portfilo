    ...
    return (
        ...
        <div className='mt-3'>
            <div className='lg:h-[310px] max-[600px]:h-[450px] bg-red-600  relative rounded-t-lg'>
                <Lottie
                    className='absolute top-0 left-0  lg:z-0 max-[600px]:z-1'
                    animationData={banner}
                    loop={true}
                />
                    <div className='lg:flex mt-4'>
                        <div className='lg:w-1/2 flex justify-center items-center '>
                            <img className=' lg:h-3/4 max-[600px]:h-60 lg:absolute lg:bottom-[-20px] lg:left-[50px] mt-9 z-4' src={profile} alt="profile" />
                        </div>
