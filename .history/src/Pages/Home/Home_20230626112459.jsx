...
const Home = () => {
    ...
    return (
        <div className='mt-3 '>
            <div
                ...
                <div className='lg:flex mt-4'>
                    <div className='lg:w-5/12 flex justify-center items-center '>
                        <img className=' lg:h-3/4 max-[600px]:h-60 lg:absolute lg:bottom-[-25px] lg:left-[75px] mt-9 z-40' src={profile} alt="profile" />
                    </div>
                    <div className='lg:w-1/2 flex lg:justify-start  items-center max-[600px]:justify-center max-[600px]:mt-[-20px]'>
                        <div className='mt-20 w-auto'>
                            <h3 className='text-5xl text-white font-extrabold font-sans tracking-normal'>Md Ibrahim</h3>
                             <TextTransition className='text-center mt-3 mb-2 ms-10 text-xl text-white font-bold font-poppins' springConfig={presets.slow}>{TEXTS[index % TEXTS.length]}</TextTransition>
            ...
            <div className='bg-white rounded-b-lg drop-shadow-xl'>
                <Me />
            </div>
        </div>
    );
