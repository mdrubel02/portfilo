        ...
        <section className='max-w-4xl mx-auto'>
            <div className='flex flex-col md:flex-row'>
                ...
                <div className='md:w-3/6 lg:mt-16 max-[600px]:ms-5'>
                    <div>
                        <h4 className='text-[#424242] '>Age: <span className='ms-4'>21</span></h4>
                        <h4 className='text-[#424242] '>Address: <span className='ms-4'>Dhaka,Bangladesh</span></h4>
                        <h4 className='text-[#424242] '>Email: <span className='ms-4'>mdibrahim529907@gmail.com</span></h4>
                        <h4 className='text-[#424242] '>Phone: <span className='ms-4'>+8801923099108</span></h4>
                        <h4 className='text-[#424242] '>Occupation: <span className='ms-4'>Student</span></h4>
                    </div>
                </div>
            </div>
        </section>
