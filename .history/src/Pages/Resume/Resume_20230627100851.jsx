                                ...
                                <div className='ms-3' >
                                    <div className="card rounded-none w-96 bg-base-100 shadow-xl border-l-4 border-[#2eca7f] mt-4 max-[600px]:mx-auto">
                                        <div className="card-body">
                                            ...
                                            <p className='text-[#2eca7f] font-bold'>Overview: <span className='text-[#424242] font-normal'> Smart Watch Resales and mainly this website reuse watch sells </span></p>
