                                ...
                                <div className='ms-3' >
                                    <div className="card rounded-none w-96 bg-base-100 shadow-xl border-l-4 border-[#2eca7f] mt-4 max-[600px]:mx-auto">
                                        <div className="card-body">
                                            ...
                                            <p className='text-[#2eca7f]'>Overview: <span> Smart Watch Resales and mainly this website reuse watch sells </span></p>
                                            <a className='text-[#2eca7f]' href="https://organic-food-d154a.web.app/" target="_blank">live Link</a>
                                        </div>
                                    </div>
                                    <div className="card rounded-none w-96 bg-base-100 shadow-xl border-l-4 border-[#2eca7f] mt-4 max-[600px]:mx-auto">
                                        <div className="card-body">
