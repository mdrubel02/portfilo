        ...
        <div className="card w-96  shadow-xl mb-4">
            ...
            <div className="card-body">
                ...
                <div className="card-actions ">
                   ...
                   <Link to={`/details/${id}`}>
                   <button className="btn btn-outline btn-sm bg-[#2eca7f] border-0 text-white hover:bg-white hover:text-[#2eca7f] hover:drop-shadow-xl"><Link>Details</Link></button></Link>
                </div>
            </div>
        </div>
    );
