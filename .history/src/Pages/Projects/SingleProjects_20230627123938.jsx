...
const SingleProjects = ({ project }) => {
    ...
    return (
        <div className="card w-96  shadow-xl mb-4">
            <figure className='-48 rounded-md mx-auto w-[90%]'><img className='h-full grayscale rounded-md hover:grayscale-0 transition-all duration-700 ease-in hover:scale-[1.2]' src={image} alt="Shoes" /></figure>
