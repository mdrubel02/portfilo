...
const Navbar = () => {
    ...
    <li className='flex items-center'>
        <NavLink
            ...
            aria-label="home"
            title="home"
            className={({ isActive }) => isActive ? "after:content-['*'] after:ml-0.5 absolute bottom-[-4px] left-[30px] block text-sm font-medium w-[30px] h-[2px]" : "font-bold transition-colors duration-100 text-primary"}
        >
            Home
        </NavLink>
