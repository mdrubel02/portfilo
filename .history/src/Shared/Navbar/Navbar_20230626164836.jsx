...
const Navbar = () => {
    ...
    return (
        <div className="py-5 mx-auto px-2  max-[600px]:px-4 font-jost sticky top-0 bg-white z-50 shadow-2xl">
            <div className="relative flex items-center justify-between z-30">
                ...
                >
                    ...
                    <span className='text-primary font-bold text-3xl '>furniture</span>
                </Link>
