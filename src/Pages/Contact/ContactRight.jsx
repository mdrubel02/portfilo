                ...
                <div className='mt-8'>
                    <form action="" onSubmit={handleSendEmail} >
                        <div>
                            ...
                            <input type="text" name='name' placeholder="Mr. Alex" className="input input-bordered w-full" required />
                            <label className="label">
                                <span className='text-secondary' >Your Email</span>
                            </label>
                            <input type="email" name='email' placeholder="alex@gmail.com" className="input input-bordered w-full" required/>
                            <label className="label">
                                <span className="text-secondary">Your Message</span>
                            </label>
                            <textarea name='message' required rows="6" className="textarea textarea-bordered w-full" placeholder="Hi! I want to hire you for my company for the front-end developer role"></textarea>
